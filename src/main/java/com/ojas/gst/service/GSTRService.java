...
public interface GSTRService {
 Gstr1Request save(Gstr1Request gstr1Request);
 
	//RefferenceId getGSTRByGSTIN(GSTR1Entity gstr1Entity);
//	TXPADataResponse getGSTR1TxpdaDataByGSTIn(GSTR1Entity gstr1Entity);

	TXPADataResponse getGSTR1TxpdaDataByGSTIn(String gstin, String ret_period);

	RefferenceId getGSTRByGSTIN(String gstin, String ret_period);
	Gstr1Request getGSTR1details(String gstin, String ret_period);
